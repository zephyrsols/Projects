...
class ShapesVideoSongs extends StatefulWidget {
  const ShapesVideoSongs({super.key});

  @override
  State<ShapesVideoSongs> createState() => _ShapeVideoSongsState();
}

class _ShapeVideoSongsState extends State<ShapesVideoSongs> {
  @override
  Widget build(BuildContext context) {
    ...
    return GridViewsItems(contentList: contentList, title: "SHAPE VIDEO SONGS",);
  }
}
