package com.androidmarket.imagegenerator.features.featuresfoto.puzzle.straight;
...
class StraightUtils {
    ...
    static StraightLine createLine(StraightArea straightArea, Line.Direction direction, float f) {
    ...
    static Pair<List<StraightLine>, List<StraightArea>> cutArea(StraightArea straightArea, int i, int i2) {
        int i3;
        List<StraightArea> arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList(i);
        StraightArea straightArea2 = new StraightArea(straightArea);
        for (int i4 = i + 1; i4 > 1; i4--) {
            StraightLine createLine = createLine(straightArea2, Line.Direction.HORIZONTAL, ((float) (i4 - 1)) / ((float) i4));
        ...
        while (true) {
            ...
            StraightLine createLine2 = createLine(straightArea3, Line.Direction.VERTICAL, ((float) (i5 - 1)) / ((float) i5));
        ...
        List<StraightLine> arrayList4 = new ArrayList();
    ...
    static Pair<List<StraightLine>, List<StraightArea>> cutAreaSpiral(StraightArea straightArea) {
        List<StraightLine> arrayList = new ArrayList();
        List<StraightArea> arrayList2 = new ArrayList();
