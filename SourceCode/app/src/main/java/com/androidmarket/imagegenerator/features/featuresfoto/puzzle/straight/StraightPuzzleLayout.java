...
public abstract class StraightPuzzleLayout implements PuzzleLayout {
    ...
    public void setAreas(List<StraightArea> list) {
        this.areas = list;
    }
    ...
    public void setAreaComparator(Comparator<StraightArea> comparator) {
    ...
    public void setOuterArea(StraightArea straightArea) {
