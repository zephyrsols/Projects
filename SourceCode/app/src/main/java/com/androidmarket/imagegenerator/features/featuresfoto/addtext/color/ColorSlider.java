package com.androidmarket.imagegenerator.features.featuresfoto.addtext.color;
...
public class ColorSlider extends View {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
           final int[] ColorSlider = {R.attr.cs_colors, R.attr.cs_from_color, R.attr.cs_hex_colors, R.attr.cs_steps, R.attr.cs_to_color};
