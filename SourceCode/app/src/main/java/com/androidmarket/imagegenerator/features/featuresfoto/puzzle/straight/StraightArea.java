...
import com.androidmarket.imagegenerator.features.featuresfoto.puzzle.Area;
...
class StraightArea implements Area {
    ...
    private void setBaseRect(RectF rectF) {
        ...
        this.lineLeft = new StraightLine(pointF, pointF3);
        this.lineTop = new StraightLine(pointF, pointF2);
        this.lineRight = new StraightLine(pointF2, pointF4);
        this.lineBottom = new StraightLine(pointF3, pointF4);
    }
    ...
    public List<Line> getLines() {
        return Arrays.asList(new Line[]{this.lineLeft, this.lineTop, this.lineRight, this.lineBottom});
    }
