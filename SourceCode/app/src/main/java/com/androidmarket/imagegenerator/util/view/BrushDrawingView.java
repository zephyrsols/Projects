...
public class BrushDrawingView extends View {
    public static final int DRAW_GENNERAL = 1;
    public static final int DRAW_MAGIC = 3;
    public static final int DRAW_NEON = 2;
    ...
    public void onDraw(Canvas canvas) {
        ...
        while (it.hasNext()) {
            ...
            if (point.vector2 != null) {
                this.tempRect.set(point.vector2.f210x, point.vector2.f212y, point.vector2.f211x1, point.vector2.f213y1);
