package com.androidmarket.imagegenerator.features.sticker;
...
public class StickerView extends RelativeLayout {
    ...
    public StickerView(Context context, AttributeSet attributeSet, int i) {
       ...
       final int[] StickerView = {R.attr.borderAlpha, R.attr.borderColor, R.attr.bringToFrontCurrentSticker, R.attr.showBorder, R.attr.showIcons};
        ...
        try {
            ...
            try {
                ...
                this.borderPaint.setColor(typedArray.getColor(1, Color.parseColor("#ff4d6a")));
    ...
    public void configDefaultIcons() {
        ...
        BitmapStickerIcon bitmapStickerIcon2 = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_scale_white_18dp), 3, BitmapStickerIcon.ZOOM);
        bitmapStickerIcon2.setIconEvent(new ZoomIconEvent());
        BitmapStickerIcon bitmapStickerIcon3 = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_flip_white_18dp), 1, BitmapStickerIcon.FLIP);
        bitmapStickerIcon3.setIconEvent(new FlipHorizontallyEvent());
        BitmapStickerIcon bitmapStickerIcon4 = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.icon_edit), 2, BitmapStickerIcon.EDIT);
            ...
            if (this.showIcons) {
                ...
                while (i < this.icons.size()) {
                    ...
                    switch (bitmapStickerIcon.getPosition()) {
                        ...
                        case 3:
                            if ((!(this.handlingSticker instanceof TextSticker) || !bitmapStickerIcon.getTag().equals(BitmapStickerIcon.ROTATE)) && (!(this.handlingSticker instanceof DrawableSticker) || !bitmapStickerIcon.getTag().equals(BitmapStickerIcon.ZOOM))) {
                                if (this.handlingSticker instanceof BeautySticker) {
