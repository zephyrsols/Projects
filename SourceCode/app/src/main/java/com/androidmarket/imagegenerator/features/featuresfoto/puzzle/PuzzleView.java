...
public class PuzzleView extends StickerView {
        ...
        this.switchToSwapAction = new Runnable() {
            public void run() {
                if (PuzzleView.this.canSwap) {
                    ActionMode unused = PuzzleView.this.currentMode = ActionMode.SWAP;
    ...
    public void replace(Bitmap bitmap, String str) {
        ...
        replace((Drawable) bitmapDrawable, str);
    }
    ...
    public void addPiece(Bitmap bitmap) {
        ...
        bitmapDrawable.setAntiAlias(true);
        bitmapDrawable.setFilterBitmap(true);
        addPiece((Drawable) bitmapDrawable, (Matrix) null);
    }
    ...
    public void addPiece(Bitmap bitmap, Matrix matrix, String str) {
        ...
        bitmapDrawable.setAntiAlias(true);
        bitmapDrawable.setFilterBitmap(true);
        addPiece((Drawable) bitmapDrawable, matrix, str);
    }
        ...
        post(new Runnable() {
            public void run() {
                if (i < PuzzleView.this.puzzlePieces.size()) {
                    PuzzlePiece unused = PuzzleView.this.previousHandlingPiece = PuzzleView.this.handlingPiece = (PuzzlePiece) PuzzleView.this.puzzlePieces.get(i);
    ...
    public int getHandlingPiecePosition() {
        ...
        return this.puzzlePieces.indexOf(this.handlingPiece);
    }
